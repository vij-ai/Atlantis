  ...
  return (
    <ScrollView>
      <View style={styles.container}>
        ...
        <Text>
          Buda Terms of Service 1. Terms By accessing our app, Buda, you are
          ...
          terms, you are prohibited from using or accessing Buda. The materials
          contained in Buda are protected by applicable copyright and trademark
          law. 2. Use License Permission is granted to temporarily download one
          copy of Buda per device for personal, non-commercial transitory
          ...
          engineer any software contained in Buda; remove any copyright or other
          ...
          restrictions and may be terminated by Buda at any time. Upon
          ...
          possession whether in electronic or printed format. 3. Disclaimer The
          materials within Buda are provided on an 'as is' basis. Buda makes no
          warranties, expressed or implied, and hereby disclaims and negates all
          other warranties including, without limitation, implied warranties or
          conditions of merchantability, fitness for a particular purpose, or
          non-infringement of intellectual property or other violation of
          rights. Further, Buda does not warrant or make any representations
          concerning the accuracy, likely results, or reliability of the use of
          the materials on its website or otherwise relating to such materials
          or on any sites linked to Buda. 4. Limitations In no event shall Buda
          ...
          interruption) arising out of the use or inability to use Buda, even if
          Buda or a Buda authorized representative has been notified orally or
          ...
          materials appearing in Buda could include technical, typographical, or
          photographic errors. Buda does not warrant that any of the materials
          on Buda are accurate, complete or current. Buda may make changes to
          the materials contained in Buda at any time without notice. However
          Buda does not make any commitment to update the materials. 6. Links
          Buda has not reviewed all of the sites linked to its app and is not
          responsible for the contents of any such linked site. The inclusion of
          any link does not imply endorsement by Buda of the site. Use of any
          such linked website is at the user's own risk. 7. Modifications Buda
          may revise these terms of service for its app at any time without
          notice. By using Buda you are agreeing to be bound by the then current
          version of these terms of service. 8. Governing Law These terms and
          conditions are governed by and construed in accordance with the laws
          of Kochi and you irrevocably submit to the exclusive jurisdiction of
          the courts in that State or location.
        </Text>
        <Title style={styles.titleText}>Privacy policy </Title>
        <Text>
          Privacy Policy Your privacy is important to us. It is Buda's policy to
          respect your privacy regarding any information we may collect from you
          through our app, Buda. We only ask for personal information when we
